...
function ProductList({ onHomeClick }) {
  ...
  const isAddedToCart = (plantName) => addedToCart[plantName];
        ...
        <div style={styleObjUl}>
          ...
          <div>
            <a href="/" onClick={handleCartClick} style={styleA}>
              <h1 className="cart">
                <span className="cart_quantity_count">{numOfItems}</span>
                <svg
          ...
          {plantsArray.map((section) => (
            <div key={section.category}>
              <div className="plantname_heading">
                <h1 className="plant_heading">{section.category}</h1>
              </div>
              <div className="product-list">
                {section.plants.map((plant) => {
                  const addedToCart = isAddedToCart(plant.name);
